using System;
using WareHouse.Api.Infrastructure.Logging;

namespace GuessWord.Api.Infrastructure.Logging;
...
public class Logger : ILog
{
    ...
    {
        get { return _logger.IsEnabled(Serilog.Events.LogEventLevel.Error); }
    }
    public bool IsFatalEnabled
    {
        get { return _logger.IsEnabled(Serilog.Events.LogEventLevel.Fatal); }
    }
    public bool IsInfoEnabled
    {
        get { return _logger.IsEnabled(Serilog.Events.LogEventLevel.Information); }
    }
    public bool IsWarnEnabled
    {
        get { return _logger.IsEnabled(Serilog.Events.LogEventLevel.Warning); }
    }
    ...
    {
        _logger.Debug(format, exception, args);
    }
    ...
    {
        _logger.Information(message.ToString(), exception);
    }
    ...
    {
        _logger.Information(format, exception, args);
    }
